    ...
    <section id="concept" className="concept-page" ref={ref}>
      ...
      <div className="cp-links">
        ...
        <div className="cp-link fade d1">
          ...
          <a className="cp-link-btn" href="#">Online store</a>
        </div>
      </div>
    </section>);
  ...
  return (
    <section id="dresses" className="concept-page" ref={ref}>
      ...
      <div className="dress-grid fade">
        ...
        <img key={n} className="dress-grid-img" src={`assets/dress-${n}.jpg`} alt="ウェディングドレス" loading="lazy" />
        )}
      </div>
    ...
    <div className="fab">
      <div className="promo-wrap">
        ...
        <a className="promo" href="#/campaign">
          <span className="promo-tag">年内挙式・披露宴限定</span>
          <span className="promo-amt"><span className="promo-max">MAX</span><span className="promo-num">45</span><span className="promo-unit">万円</span><span className="promo-off">OFF</span></span>
          <span className="promo-cta">詳細<span className="promo-arw">→</span></span>
        </a>
      </div>
    </div>);
...
const PAGES = [
  ...
  { slug: 'dresses',  en: 'Dress',    jp: 'ドレス',        Comp: Dresses,  img: 'assets/dress-main.jpg', noHeroImg: true,
