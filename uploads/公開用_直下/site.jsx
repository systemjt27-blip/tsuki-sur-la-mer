...
function FloatingCTA() {
  return (
    <div className="fab">
      <a className="fairlink" href="#/fair">
        <span className="ic">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3">
            <path d="M12 21s-7-5.2-7-10a7 7 0 1114 0c0 4.8-7 10-7 10z" /><circle cx="12" cy="11" r="2.4" />
          </svg>
        </span>
        <span className="fab-txt"><span className="fab-en">Bridal Fair</span>ブライダルフェア</span>
      </a>
    </div>);
...
function HomeIndex() {
  ...
  const seqPages = PAGES.filter((p) => p.slug !== 'message');
  return (
